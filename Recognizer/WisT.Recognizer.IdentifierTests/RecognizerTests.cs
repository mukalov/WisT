...
namespace WisT.Recognizer.Identifier.Tests
{
    ...
    public class RecognizerTests
    {
        ...
        public void Test2()
        {
            Bitmap load_img = new Bitmap(@"C:\Users\pavlo\source\repos\WisT\Recognizer\TestSample\TestPerson2\0e231aaa-8ed8-4043-aa01-b5b40ff37f07.bmp");
            _testImage = new FaceImage(load_img); // face detection there
            _testImage.Id = new Identifier(0);
            string[] img_pathes = Directory.GetFiles(@"C:\Users\pavlo\source\repos\WisT\Recognizer\TestSample\TestPerson2\TestBatch");
        ...
        public void Test3()
        {
            Bitmap load_img = new Bitmap(@"C:\Users\pavlo\source\repos\WisT\Recognizer\TestSample\TestPerson3\bc23325e-a23c-45ac-b970-e26726eca09c.bmp");
            _testImage = new FaceImage(load_img); // face detection there
            _testImage.Id = new Identifier(0);
            string[] img_pathes = Directory.GetFiles(@"C:\Users\pavlo\source\repos\WisT\Recognizer\TestSample\TestPerson3\TestBatch");
        ...
        public void Test4()
        {
            Bitmap load_img = new Bitmap(@"C:\Users\pavlo\source\repos\WisT\Recognizer\TestSample\TestPerson4\28e24e03-20cf-4c1b-bf7d-5d82d67d15f7.bmp");
            _testImage = new FaceImage(load_img); // face detection there
            _testImage.Id = new Identifier(0);
            string[] img_pathes = Directory.GetFiles(@"C:\Users\pavlo\source\repos\WisT\Recognizer\TestSample\TestPerson4\TestBatch");
